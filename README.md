...
- **Frontend**: Streamlit offers an interactive UI for querying and viewing analytics.

## Project Structure
```
Hotel-booking-QA/
├── db/
│   └── bookings.db         # SQLite database with preprocessed booking data
├── models/
│   └── bookings_index.faiss # FAISS index for RAG fallback
├── src/
